...
-- You can change the name of the Weapon Names or add more | Podes trocar o nome das Armas ou adicionar mais
WeaponNames = {
...
function ShowDebug(text)
    ...
    AddTextComponentSubstringPlayerName("~b~rl_logs Debus:~s~\n"..text)
